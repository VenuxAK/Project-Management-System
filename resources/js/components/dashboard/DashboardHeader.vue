<script setup>
import UsersCircleIcon from "@/icons/UsersCircleIcon.vue";
...
<template>
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6">
        ...
        >
            ...
            >
                <project-icon classList="text-gray-800 dark:text-white/90" />
            </div>
        ...
        >
            <div
                class="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl dark:bg-gray-800"
            >
                <task-list-icon classList="text-gray-800 dark:text-white/90" />
            </div>
        ...
        >
            ...
            >
                <users-circle-icon
                    classList="text-gray-800 dark:text-white/90"
                />
            </div>
